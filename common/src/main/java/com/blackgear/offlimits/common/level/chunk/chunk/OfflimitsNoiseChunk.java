...
import com.blackgear.offlimits.common.level.chunk.Beardifier;
import com.blackgear.offlimits.common.level.chunk.noisemodifiers.NoodleCavifier;
import com.blackgear.offlimits.common.level.chunk.Cavifier;
...
import com.blackgear.offlimits.common.level.chunk.noise.BlockNoiseColumn;
...
import com.blackgear.offlimits.common.level.chunk.noisemodifiers.NoodleCaveNoiseModifier;
...
public class OfflimitsNoiseChunk extends NoiseChunk {
    ...
    public OfflimitsNoiseChunk(ChunkGenerator generator, TerrainContext context, NoiseGeneratorSettings settings, WorldgenRandom random) {
        super(generator, context, settings, random);
    }
    ...
    public int getBaseHeight(int x, int z, Heightmap.Types types) {
        ...
        int genHeight = Math.min(this.minY() + this.genDepth(), this.context.maxBuildHeight());
    ...
    public BaseStoneSource getBaseNoiseSource() {
        return new SimpleStoneSource(this.settings.getDefaultBlock());
    }
    ...
    private DoubleFunction<BaseStoneSource> createBaseStoneSource(int minY, ChunkPos pos, Consumer<NoiseInterpolator> interpolator) {
        return value -> this.getBaseNoiseSource();
    }
